    ...
    {isLoggedIn ? (
      ...
      <section className="nav-bar">
        <div className="nav-left">
          <span className="nav-logo" style={{visibility: 'visible'}}>WeatherThing</span>
          <a href="#"className="nav-link hidden-when-small">Hourly</a>
          <a href="# "className="nav-link hidden-when-small">10-Day</a>
        </div>
