...
export const getCurrentWeatherThunk = (lat, lng) => {
  return async (dispatch) => {
    try {
      ...
      let location = {
        city: weatherData.relativeLocation.properties.city,
        state: weatherData.relativeLocation.properties.state,
      };
      ...
      dispatch(
        getCurrentWeather(
          weekly.data.properties.periods,
